...
public class Fragment_KPS extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, UtilsInternet.XCallBack {
    private ListView mListViewKPS;
    ...
    private void getChildView(View view) {
        mListViewKPS = (ListView) view.findViewById(R.id.lv_reuse_order);
    ...
    protected void setData() {
        super.setData();
        mListViewKPS.setAdapter(pAdapter);
    }
    ...
    protected void initEvent() {
        ...
        mListViewKPS.setOnItemClickListener(this);
