...
public class BtnChangeAdapter_4_1 extends RecyclerView.Adapter<BtnChangeAdapter_4_1.MyViewHolder> {
    ...
    public BtnChangeAdapter_4_1(Context context, List<Label.CloStyleBean> data){
        mContext = context;
        mData = data;
