...
public class MySelfDialog extends Dialog{
    ...
    private OnAliPayClickListener mAliPayListener;
    ...
    public void setOnAliPayListener(OnAliPayClickListener aliPayListener){
    ...
    private void initView() {
        ...
        mAliPay = (RelativeLayout) findViewById(R.id.rl_myself_dialog_alipay);
    }
