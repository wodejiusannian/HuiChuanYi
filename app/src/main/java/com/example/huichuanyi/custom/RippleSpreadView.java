...
public class RippleSpreadView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        innerColor = typedArray.getColor(R.styleable.RippleSpreadView_rsv_innerCircleColor, Color.parseColor("#bbbbbb"));
        ...
        outColor = typedArray.getColor(R.styleable.RippleSpreadView_rsv_outCircleColor, Color.parseColor("#bbbbbb"));
        ...
        innerSizeAnimator.setRepeatCount(ValueAnimator.INFINITE);//无限循环
        innerSizeAnimator.setRepeatMode(ValueAnimator.INFINITE);//
