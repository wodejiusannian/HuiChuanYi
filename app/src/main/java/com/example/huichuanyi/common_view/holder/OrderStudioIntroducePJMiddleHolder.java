...
// ┃┫┫　┃┫┫
// ┗┻┛　┗┻┛
public class OrderStudioIntroducePJMiddleHolder extends BaseViewHolder<OrderStudioIntroducePJMiddleModel> {

    public OrderStudioIntroducePJMiddleHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setUpView(OrderStudioIntroducePJMiddleModel model, int position, final MultiTypeAdapter adapter) {
