...
// ┃┫┫　┃┫┫
// ┗┻┛　┗┻┛
public class OrderStudioIntroducePJTopHolder extends BaseViewHolder<OrderStudioIntroducePJTopModel> {

    public OrderStudioIntroducePJTopHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setUpView(OrderStudioIntroducePJTopModel model, int position, final MultiTypeAdapter adapter) {
