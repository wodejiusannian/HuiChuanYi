...
public class ItemHmShopCarShops implements Visitable {
    ...
    public ItemHmShopCarShops(boolean isSelect, int count, boolean edit, String goodsColor, String goodsId, String goodsName, String goodsPicture, double goodsPrice, String goodsSize, String id, int orderNumber, String kindName) {
        this.isSelect = isSelect;
        this.count = count;
        this.edit = edit;
