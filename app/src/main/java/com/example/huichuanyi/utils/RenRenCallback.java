...
import static com.example.huichuanyi.utils.OverLayCardLayoutManager.MAX_SHOW_COUNT;
import static com.example.huichuanyi.utils.OverLayCardLayoutManager.SCALE_GAP;
import static com.example.huichuanyi.utils.OverLayCardLayoutManager.TRANS_Y_GAP;
...
public class RenRenCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public void toLeft(RecyclerView recyclerView, SwipePosition swipePosition) {
        if (swipePosition != null) {
            this.mSwipePosition = swipePosition;
        }
    ...
    public void toRight(RecyclerView recyclerView, SwipePosition swipePosition) {
        if (swipePosition != null) {
            this.mSwipePosition = swipePosition;
        }
        if (check(recyclerView)) {
    ...
    private void animTo(final RecyclerView recyclerView, final boolean right) {
        ...
        mSwipePosition.swipePosition(position);
        /*if (!right) {
