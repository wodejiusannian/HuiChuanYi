...
public class HMStateActivity extends BaseActivity {

    @ViewInject(R.id.wb_stat_loading_html)
    private WebView mWeb;

    @ViewInject(R.id.pr_stat_loading_hint)
    private ProgressBar mLoading;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_web_stat);
