        ...
        public void handleMessage(Message msg) {
            ...
            switch (isFirst) {
                case 1:
                    ...
                    break;
                case 0:
                    startActivity(new Intent(MySplashActivity.this, LoadingActivity.class));
                    break;
            }
            finish();
        }
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (TextUtils.equals("0", ret)) {
                    MySharedPreferences.save365(MySplashActivity.this, "365");
                } else {
                    try {
                        ...
                        MySharedPreferences.saveActivity(MySplashActivity.this, activity, price);
